...
encoder_pp_emb = Embedding(x_voc_size, 100, weights = [embedding_matrix], trainable = True)(encoder_pp_inputs)
encoder_ui_emb = Embedding(x_voc_size, 100, weights = [embedding_matrix], trainable = True)(encoder_ui_inputs)
encoder_cg_emb = Embedding(x_voc_size, 100, weights = [embedding_matrix], trainable = True)(encoder_cg_inputs)
